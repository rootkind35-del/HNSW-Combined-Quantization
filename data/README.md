...
Do dung lượng tập dữ liệu 16.45 triệu bản ghi và các tệp nhị phân float32/int8 rất lớn (> 20 GB), toàn bộ dữ liệu nhị phân được lưu trữ bên ngoài Git repository.
